                ...
                <div class="container py-5 mt-5 text-center">
                    <div class="row">
                        <div class="mt-5 text-center">
                            <img class="w-25" alt="Logo" src="logo.png" />
                            <h3>Hey dev! Join into</h3>
                            <h1 className="sm:">TypePlanet</h1>
                            <input type="submit" className="btn btn-outline-light btn-lg px-5 custom-primary-button" value="Discover Now" />
                        ...
                        <div class="mt-5 d-flex-inline text-center">
                            ...
                            <img class="w-25 float-right" alt="Astro" src="astro.png" />
                        </div>
                    </div>
                </div>
            </section>
